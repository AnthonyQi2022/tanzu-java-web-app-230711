...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=AnthonyQi2022&repo=tanzu-java-web-app-230711",
  "projectName" : "tanzu-java-web-app-230711",
  "repositoryPrefix" : "230711"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tanzu-java-web-app-2...(truncated)]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->230711]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=AnthonyQi2022&repo=tanzu-java-web-app-230711'
